<?php $__env->startSection('title', 'Master Ledger'); ?>
    ...
    <div class="table-responsive">
        <table class="table table-vcenter card-table">
            ...
            <tbody id="ledger-table">
                ...
                <tr data-id="<?php echo e($ledger->id); ?>">
                    <td class="editable" data-field="kode"><?php echo e($ledger->kode); ?></td>
                    <td class="editable" data-field="nama"><?php echo e($ledger->nama); ?></td>
                    <td class="editable" data-field="tipe_akun"><?php echo e(ucfirst($ledger->tipe_akun)); ?></td>
                    <td class="editable" data-field="grup"><?php echo e($ledger->grup); ?></td>
                    <td class="editable" data-field="saldo_normal"><?php echo e(ucfirst($ledger->saldo_normal)); ?></td>
                    <td class="actions">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\akuntansi\resources\views/ledger/index.blade.php ENDPATH**/ ?>