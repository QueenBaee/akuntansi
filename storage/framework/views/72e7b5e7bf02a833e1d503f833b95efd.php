<?php $__env->startSection('title', 'Kelola Ledger'); ?>
        ...
        <div class="table-responsive">
            <table class="table table-vcenter card-table">
                ...
                <tbody id="ledgerTableBody">
                    ...
                    <tr id="row-<?php echo e($ledger->id); ?>" data-id="<?php echo e($ledger->id); ?>">
                        <td class="editable" data-field="nama_ledger"><?php echo e($ledger->nama_ledger); ?></td>
                        <td class="editable" data-field="kode_ledger"><?php echo e($ledger->kode_ledger); ?></td>
                        <td class="editable" data-field="tipe_ledger">
                            <span class="badge bg-<?php echo e($ledger->tipe_ledger == 'kas' ? 'primary' : 'success'); ?>">
                                <?php echo e(ucfirst($ledger->tipe_ledger)); ?>

                            </span>
                        </td>
                        <td class="editable" data-field="deskripsi"><?php echo e($ledger->deskripsi); ?></td>
                        <td class="editable" data-field="is_active">
                            <span class="badge bg-<?php echo e($ledger->is_active ? 'success' : 'danger'); ?>">
                                <?php echo e($ledger->is_active ? 'Aktif' : 'Tidak Aktif'); ?>

                            </span>
                        </td>
                        <td>
                            <div class="btn-list flex-nowrap">
                                <button class="btn btn-sm edit-btn" onclick="editRow(<?php echo e($ledger->id); ?>)">Edit</button>
                                <button class="btn btn-sm btn-success save-btn" onclick="saveRow(<?php echo e($ledger->id); ?>)" style="display: none;">Simpan</button>
                                <button class="btn btn-sm btn-secondary cancel-btn" onclick="cancelEdit(<?php echo e($ledger->id); ?>)" style="display: none;">Batal</button>
                                <button class="btn btn-sm btn-danger" onclick="deleteLedger(<?php echo e($ledger->id); ?>)">Hapus</button>
                            </div>
                        </td>
                    </tr>
