...
Route::middleware('auth')->group(function () {
    ...
    | JOURNALS (DIPERBAIKI)
    |--------------------------------------------------------------------------
    | - Route update manual (CashBankJournalController)
    | - Resource journals (Web\JournalController) tanpa update
    */

    // Manual journals (cash/bank)
    ...
    // Resource journals (WEB) TANPA create, store, destroy, update
    Route::resource('journals', \App\Http\Controllers\Web\JournalController::class)
        ->except(['create', 'store', 'destroy', 'update']);
    ...
    */
    ...
    Route::resource('memorials', \App\Http\Controllers\Web\MemorialController::class)
        ->except(['create', 'store', 'destroy', 'update']);
