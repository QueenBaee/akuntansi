                ...
                <div class="navbar navbar-light">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown {{ request()->routeIs('accounts.*') || request()->routeIs('journals.*') || request()->routeIs('cash-transactions.*') ? 'active' : '' }}">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item {{ request()->routeIs('accounts.*') ? 'active' : '' }}" href="{{ route('accounts.index') }}">Chart of Accounts</a>
                                    <a class="dropdown-item {{ request()->routeIs('journals.*') ? 'active' : '' }}" href="{{ route('journals.index') }}">Journal Entry</a>
                                    <a class="dropdown-item {{ request()->routeIs('cash-transactions.*') ? 'active' : '' }}" href="{{ route('cash-transactions.index') }}">Cash Transactions</a>
                                </div>
                            </li>
                            ...
                            <li class="nav-item {{ request()->routeIs('trial-balance.index') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('trial-balance.index') }}">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                            ...
                            <li class="nav-item {{ request()->routeIs('cashflow.index') ? 'active' : '' }}">
